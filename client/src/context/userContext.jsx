...
export const UserContextProvider = ({children}) => {
    ...
    return(
        <UserContext.Provider value={{events, setEvents, session, setSession, productions, setProductions, message, setMessage, loginContext}}>{children}</UserContext.Provider>
    )
}
