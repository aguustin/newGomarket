...
const NewCortesie = () => {
    ...
    return(
        <>
        <div className="new-cortesie-container relative mx-12 mt-[30px] bg-gray-800 border-[1px] border-gray-600 rounded-2xl p-5 mb-8">
            <h2 className="text-3xl text-gray-300!">Crear Lista</h2>
            <div className="new-cortesie flex flex-wrap items-center justify-between mt-5 mb-10 bg-gray-900 rounded-2xl p-9">
                <div className="text-gray-400!">
                    <h2 className="text-2xl text-gray-300! underline mb-3">Pasos para crear tu lista:</h2>
                    <p className="text-lg flex items-center"><p className="flex items-center justify-center bg-gray-100! border-[1px] border-gray-300 rounded-[200px] w-[40px] h-[40px] mr-3 mt-1 secondary-p">1</p> Crear un archivo excel</p>
                    <p className="text-lg flex items-center"><p className="flex items-center justify-center bg-gray-100! border-[1px] border-gray-300 rounded-[200px] w-[40px] h-[40px] mr-3 mt-1 secondary-p">2</p> En la columna 'A' ingresar los nombres y en la columna 'B' los emails</p>
                    <p className="text-lg flex items-center"><p className="flex items-center justify-center bg-gray-100! border-[1px] border-gray-300 rounded-[200px] w-[40px] h-[40px] mr-3 mt-1 secondary-p">3</p> Una vez terminado guardar los cambios hechos en el arhivo excel</p>
                    <p className="text-lg flex items-center"><p className="flex items-center justify-center bg-gray-100! border-[1px] border-gray-300 rounded-[200px] w-[40px] h-[40px] mr-3 mt-1 secondary-p">4</p> Tocar la opcion 'Subir excel' buscar el archivo y seleccionarlo</p>
                    <p className="text-lg flex items-center"><p className="flex items-center justify-center bg-gray-100! border-[1px] border-gray-300 rounded-[200px] w-[40px] h-[40px] mr-3 mt-1 secondary-p">5</p> Confirmar la operación</p><br></br>
                </div>
                <div>
