        ...
        <div className="flex h-full justify-center p-9 mt-6">
            ...
            <div className="text-center bg-[#1e1530] p-9 rounded-xl">
                ...
                <div className="flex justify-center items-center mt-6">
                    <Link className="ml-3" to="/"><img src={instagram_profile_Png} alt=""></img></Link>
                    <Link className="ml-3" to="/"><img src={facebook_profile_Png} alt=""></img></Link>
                    <Link className="ml-3" to="/"><img src={tiktok_profile_Png} alt=""></img></Link>
                </div>
                <Link to={`/https://wa.me/${user.celular}`} className="w-[250px] mx-auto mt-9 flex justify-center text-2xl pt-4 pb-4 bg-green-800 rounded-xl">Contacto<img className="ml-4" src={whatsapp_profile_Png} alt=""></img></Link>
            </div>)}
        </div>
        </>
    )
