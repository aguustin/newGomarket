...
import ipassReducidoSvg from '../../assets/goticketImgs/IPSg.svg'
        ...
        <>
            <div className="home mb-16">
                ...
                <div className="relative w-full h-[500px] max-[440px]:h-[580px] overflow-hidden">
                    ...
                    <div className="relative z-10 flex flex-col items-center justify-center h-full text-white text-center px-4">
                        <div className="filtrar-eventos w-full max-w-4xl">
                            <img 
                                className="w-[220px] h-[120px] mx-auto mt-[-40px] max-[620px]:h-auto max-[575px]:mt-[0px] drop-shadow-2xl" 
                            ...
                            <form className="search-form justify-center flex items-center w-full mb-6">
                                <p className="text-lg w-[170px] text-white font-semibold">Buscar evento:</p><br></br>
                            ...
                            <div className="max-[575px]:w-[100%] mt-6 flex flex-wrap gap-3 justify-center items-center">
                ...
                <div className="events w-[100%] pr-10 pl-10 relative max-[750px]:px-4">
                    ...
                    {/* EVENTS GRID */}
                    <div className="events-and-categories flex items-start mt-8 py-6">
