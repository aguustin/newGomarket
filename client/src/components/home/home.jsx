        ...
        <>
            <div className="home mb-16">
                ...
                <div className="events w-[100%] pr-10 pl-10 relative">
                    {width < 1376 &&
                       <div className="categories px-6 py-4">
        <div className="flex flex-wrap gap-3 justify-center">
                        ...
                        {width > 1375 &&
                            <div className="categories w-full mt-3">
                                <div className="w-full pb-1 flex bg-gradient-to-r from-purple-600 to-pink-500 transition-all rounded-lg">
                                    ...
                                    <button className={`flex justify-center border-r-[2px] items-center border-y-white-500! text-white font-semibold text-center mt-2 p-3 w-[100%] text-[#111827] ${favoritesFilter?.length > 0 ? 'bg-gradient-to-r from-purple-600' : ''}`} onClick={() => {setCategoriaSeleccionada(''); getFavoritesEventsFunc()}}  name="favoritos"><img src={starBipng} alt="" loading="lazy"></img><p className="ml-4">Favoritos</p></button>
