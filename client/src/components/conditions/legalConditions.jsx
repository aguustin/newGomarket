...
expreso. Si es menor de edad, deberá contar con autorización de su representante legal.</p>
                    ...
                    <div className="border-b-[2px] border-gray-200!">
                        <h3 className="text-gray-300! text-2xl underline mt-4">CUARTO. Condiciones de Venta</h3>
                        <p className="text-gray-300! mt-2 text-sm mb-4">• Antes de confirmar la compra, el Usuario deberá verificar cuidadosamente la
                    ...
                    <div className="border-b-[2px] border-gray-200!">
                        <h3 className="text-gray-300! text-2xl underline mt-4">QUINTO. Condiciones de Entrega</h3>
                        <p className="text-gray-300! mt-2 text-sm mb-4">Las entradas serán enviadas al correo electrónico registrado por el Usuario, en formato
                    ...
                    <div className="border-b-[2px] border-gray-200!">
                        <h3 className="text-gray-300! text-2xl underline mt-4">NOVENO. Privacidad y Seguridad</h3>
                        <p className="text-gray-300! mt-2 text-sm mb-4">Los datos serán utilizados exclusivamente para:<br></br><br></br>
