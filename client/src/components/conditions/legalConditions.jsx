...
expreso. Si es menor de edad, deberá contar con autorización de su representante legal.</p>
                    ...
                    <div className="border-b-[2px] border-gray-200!">
                        <h3 className="text-2xl underline mt-4">PRIMERO. Condiciones Generales</h3>
                        <p className="primary-p mt-2 text-sm mb-4">La compra de entradas a través del sistema web de Go Ticket (en adelante, el
                     ...
                     <div className="border-b-[2px] border-gray-200!">
                        <h3 className="text-2xl underline mt-4">SEGUNDO. Objeto y Alcance</h3>
                        <p className="primary-p mt-2 text-sm mb-4">Go Ticket es una plataforma dedicada a la venta y distribución de entradas
                    ...
                    <div className="border-b-[2px] border-gray-200!">
                        <h3 className="text-2xl underline mt-4">TERCERO. Uso del Sitio Web</h3>
                        <p className="primary-p mt-2 text-sm mb-4">El Usuario se compromete a utilizar la página web de Go Ticket únicamente para fines
                    ...
                    <div className="border-b-[2px] border-gray-200!">
                        <h3 className="text-2xl underline mt-4">CUARTO. Condiciones de Venta</h3>
                        <p className="primary-p mt-2 text-sm mb-4">• Antes de confirmar la compra, el Usuario deberá verificar cuidadosamente la
                        información de su orden.<br></br><br></br>
                        ...
                        del evento, cargos por servicio, cambios y/o suspensión del mismo.<br></br><br></br>
                        • Las Entradas no podrán ser utilizadas para reventa o fines promocionales sin
                        autorización escrita.</p>
                    </div>
                    <div className="border-b-[2px] border-gray-200!">
                        <h3 className="text-2xl underline mt-4">QUINTO. Condiciones de Entrega</h3>
                        <p className="primary-p mt-2 text-sm mb-4">Las entradas serán enviadas al correo electrónico registrado por el Usuario, en formato
                        código QR o e-ticket. Según disponibilidad, también podrán remitirse por SMS o
                        aplicaciones de mensajería.</p>
                    </div>
                    <div className="border-b-[2px] border-gray-200!">
                        <h3 className="text-2xl underline mt-4">SEXTO. Política de Devoluciones</h3>
                        <p className="primary-p mt-2 text-sm mb-4">• No se realizan cambios ni devoluciones por errores en la compra una vez
                        ...
                        Usuario podrá solicitar la devolución.<br></br><br></br>
                        • Las entradas son al portador: en caso de pérdida, robo o reenvío indebido, Go
                        Ticket no asume responsabilidad.</p>
                    </div>
                     <div className="border-b-[2px] border-gray-200!">
                        <h3 className="text-2xl underline mt-4">SÉPTIMO. Atención al Cliente</h3>
                        <p className="primary-p mt-2 text-sm mb-4">Para consultas, reclamos o devoluciones, el Usuario podrá comunicarse con Go Ticket a
                        través del correo electrónico: goticketarg@gmail.com.</p>
                    </div>
                    <div className="border-b-[2px] border-gray-200!">
                        <h3 className="text-2xl underline mt-4">OCTAVO. Datos Personales</h3>
                        <p className="primary-p mt-2 text-sm mb-4">El Usuario consiente que Go Ticket almacene y procese sus datos personales (nombre,
                    ...
                    <div className="border-b-[2px] border-gray-200!">
                        <h3 className="text-2xl underline mt-4">NOVENO. Privacidad y Seguridad</h3>
                        <p className="primary-p mt-2 text-sm mb-4">Los datos serán utilizados exclusivamente para:<br></br><br></br>
...
Usuario o exigencia legal.</p>
                    ...
                    <div className="border-b-[2px] border-gray-200!">
                        <h3 className="text-2xl underline mt-4">DÉCIMO. Eliminación o Modificación de Datos</h3>
                        <p className="primary-p mt-2 text-sm mb-4">El Usuario podrá solicitar en cualquier momento la modificación o eliminación de sus
datos enviando un correo a goticketarg@gmail.com, o bien eliminar directamente su
cuenta desde la plataforma.</p>
                    </div>
                       <div className="border-b-[2px] border-gray-200!">
                        <h3 className="text-2xl underline mt-4">UNDÉCIMO. Exención de Responsabilidad (general)</h3>
                        <p className="primary-p mt-2 text-sm mb-4">• Go Ticket no garantiza el funcionamiento libre de errores, interrupciones o virus
                    ...
                    <div className="border-b-[2px] border-gray-200!">
                        <h3 className="text-2xl underline mt-4">DÉCIMO SEGUNDO. Uso de Cookies y Seguridad</h3>
                        <p className="primary-p mt-2 text-sm mb-4">El sitio de Go Ticket podrá utilizar cookies e identificadores de IP con el fin de mejorar
                     ...
                     <div className="border-b-[2px] border-gray-200!">
                        <h3 className="text-2xl underline mt-4">DÉCIMO TERCERO. Exención de Responsabilidades Específicas</h3>
                        <p className="primary-p mt-2 text-sm mb-4">A pesar del esfuerzo constante de Go Ticket por ofrecer la mejor experiencia posible, la
